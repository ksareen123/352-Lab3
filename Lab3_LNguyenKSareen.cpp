/*****************************************************************************
*                                                                            *
*       Source title:   Lab3_LNguyenKSareen.CPP
...
// file.
//
CLab3_LNguyenKSareen theApp(ProductDatasheetFlow);
...
BOOL CLab3_LNguyenKSareen::UserInit( void )
{
    //////////////////////////////////////////////////////////////////////////
	...
	dpinvecload( "Lab3_LNguyenKSareen.evd" ); // load vector sheet so digital pins can use machine resources
...
BOOL CLab3_LNguyenKSareen::UserExit( void )
{
    return TRUE;
}
...
BOOL CLab3_LNguyenKSareen::OnTestInit( void )
{
    //////////////////////////////////////////////////////////////////////////
...
BOOL CLab3_LNguyenKSareen::OnTestExit( void )
{
    return TRUE;
}
...
BOOL CLab3_LNguyenKSareen::OnTestStartup( void )
{
...
BOOL CLab3_LNguyenKSareen::OnTestCompletion( void )
{	
...
BOOL CLab3_LNguyenKSareen::OnLogData( void )
{
    int PassFail;
...
BOOL CLab3_LNguyenKSareen::OnFailSite( int site )
{
	if (site == MS_SITE0) {
		apuset( nOE, APU_VIOFF, 0.0, APU_30V, APU_1MA, PIN_TO_VI );
		apuset( DIR, APU_VIOFF, 0.0, APU_30V, APU_1MA, PIN_TO_VI );
...
int CLab3_LNguyenKSareen::OnSot(int SotValue)
{
    return SotValue;
}
...
BOOL CLab3_LNguyenKSareen::OnUtilError(int errnum)
{
    return TRUE;
}
...
BOOL CLab3_LNguyenKSareen::OnInterlock(ULONG intlocks)
{
    return TRUE;
}
...
/*			IO is MAX HIGH			*/
	...
	//disable device so busses are isolated
...
//Variable declarations
	RESULTS_STR apu_leakL[4];
	RESULTS_STR apu_leakL_NOE[4];
...
/*			IO is Low			*/
	...
	msLogResultAll(DSIndex++, apu_leakL, 4, 1, 2 );
	//groupgetresults(apu_leakL, 4);
	...
	apumi(nOE, 100, 10);
	groupgetresults(apu_leakL_NOE, 4);

	//log APU nOE results
	msLogResultAll(DSIndex++, apu_leakL_NOE, 4, 1, 2 );
